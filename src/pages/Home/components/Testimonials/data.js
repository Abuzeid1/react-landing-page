...
const data = [
  { name: names[0], text: texts.slice(0, 2), image: images.person1 },
  { name: names[1], text: texts.slice(2), image: images.person2 },
  { name: names[2], text: texts.slice(2), image: images.person3 },
  { name: names[3], text: texts.slice(2), image: images.person4 },
];
